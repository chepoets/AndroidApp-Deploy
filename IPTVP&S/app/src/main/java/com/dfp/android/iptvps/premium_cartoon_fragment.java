 ...
 */
public class premium_cartoon_fragment extends Fragment {
    ...
    public premium_cartoon_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_premium_cartoon_fragment, container, false);
